const cursos = [
    {nombre: "JavaScript Básico", duracion: "15 horas", precio: 19, nivel: "Básico", codigo: "#134562", imagen: "./resources/fotos/javascript-basico.png", 
        ...
        instructor: "Julio Orbegoso", foto: "./resources/fotos/Julio Orbegoso.webp", biografia:"Julio Orbegoso es ingeniero de sistemas por la UPC. Años de experiencia en la docencia de lenguajes de programación como JavaScript, Python, Assembler, C++ y C. Será tu maestro en este viaje astral hacia las profundidades de JS, tu guía universal.",
    mod1: "Introducción a JavaScript", mod2: "Sintaxis Básica", mod3: "Estructuras de Control", mod4: "Funciones y Objetos", ap1: "Ejercicios Prácticos", ap2: "Sintexis de JavaScript", ap3: "Estructuras de Control en JavaScript", ap4: "Funciones y Objetos en JavaScript"},
